...
func (rq *RegistryQuery) QueryOrganization() *OrganizationQuery {
...
func (rq *RegistryQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (rq *RegistryQuery) FirstIDX(ctx context.Context) int {
...
func (rq *RegistryQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (rq *RegistryQuery) OnlyIDX(ctx context.Context) int {
...
func (rq *RegistryQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (rq *RegistryQuery) IDsX(ctx context.Context) []int {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (rq *RegistryQuery) WithOrganization(opts ...func(*OrganizationQuery)) *RegistryQuery {
	query := (&OrganizationClient{config: rq.config}).Query()
...
func (rq *RegistryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Registry, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, registry.ForeignKeys...)
	}
...
func (rq *RegistryQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*Registry, init func(*Registry), assign func(*Registry, *Organization)) error {
	...
	for i := range nodes {
		if nodes[i].organization_registries == nil {
			continue
		}
		fk := *nodes[i].organization_registries
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "organization_registries" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (rq *RegistryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(registry.Table, registry.Columns, sqlgraph.NewFieldSpec(registry.FieldID, field.TypeInt))
	_spec.From = rq.sql
